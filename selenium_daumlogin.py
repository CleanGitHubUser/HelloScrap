...
userid = driver.find_element_by_name('id')
# @id=id 인 요소에 아이디를 입력
userid.send_keys('jeewoong92')
...
findkey = 'span["class=mails_unread emph_color txt_count"]'
...
# 로그아웃 처리
logout = 'https://logins.daum.net/accounts/logout.do?url=http%3A%2F%2Fwww.daum.net%2F%3Fnil_profile%3Dlogout'
driver.get(logout)